...
fname = 'C:/phase-to-rate/pos_info_rate_non-adjusted.xlsx'
...
ax1.set_ylabel('rate info (bits/AP)')
...
f1.savefig(f'{save_dir}figure_pos_info_rate.svg', dpi=200)
#f1.savefig(f'{save_dir}figure_pso_info_rate.png', dpi=200)
...
#fname = results_dir + 'excel/pos_info_rate_results.xlsx'
fname = 'C:/phase-to-rate/pos_info_rate_non-adjusted.xlsx'
...
ax.set_xticklabels(['EC','full', 'no ff', 'no fb', 'disinh']
                    , rotation=60)
ax.set_title('non-shuffled/shuffled rate')
...
plt.rcParams["svg.fonttype"] = "none"
f2.savefig(f'{save_dir}figure_pos_info_rate_norm.svg', dpi=200)
