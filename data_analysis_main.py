...
grid_counts, grid_phases, grid_rate_code, grid_phase_code, grid_polar_code = rate_n_phase(grid_spikes, trajectories, n_samples)

granule_counts, granule_phases, granule_rate_code, granule_phase_code, granule_polar_code = rate_n_phase(granule_spikes, trajectories, n_samples)
